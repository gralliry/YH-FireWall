...
func New(o *Option, devMap DevName2Index) (*Rule, error) {
	r := &Rule{id: sid.New(12)}
	if err := r.Update(o, devMap); err != nil {
		return nil, err
	} else {
		return r, nil
	}
...
func Parse(d *Data, devMap DevName2Index) (*Rule, error) {
	r := &Rule{id: d.ID}
	if err := r.Update(&d.Option, devMap); err != nil {
		return nil, err
	} else {
		return r, nil
	}
